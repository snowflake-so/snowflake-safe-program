...
use super::times::{days_in_month, day_of_the_week, adv_month, adv_day, adv_hour, adv_minute};
...
mod tests {
  ...
  fn to_timestamp(date: &str) -> i64 {
    let datetime = NaiveDateTime::parse_from_str(date, "%Y-%m-%d %H:%M:%S").ok().unwrap();
    datetime.timestamp()
  }
  ...
  fn test_first_of_the_month() {
    ...
    assert_eq!(to_datetime(next_execution.to_time_ts(0)), "2021-12-01 00:00:00");
  }
  ...
  fn test_feb_28th() {
    ...
    assert_eq!(to_datetime(next_execution.to_time_ts(0)), "2022-02-28 07:15:00");
  }
  ...
  fn test_feb_29th() {
    ...
    assert_eq!(to_datetime(next_execution.to_time_ts(0)), "2024-02-29 07:15:00");
  }
  ...
  fn test_next_year() {
    ...
    assert_eq!(to_datetime(next_execution.to_time_ts(0)), "2022-01-01 00:00:00");
  }
  ...
  fn test_next_month() {
    ...
    let from_ts = to_timestamp("2021-11-29 01:16:40");
    let next_execution = cron.next_event(&SnowTime::from_time_ts(from_ts)).unwrap();
    assert_eq!(to_datetime(next_execution.to_time_ts(0)), "2021-12-25 00:00:00");
  }
  ...
  fn test_next_day() {
    ...
    let from_ts = to_timestamp("2021-11-29 01:16:40");
    let next_execution = cron.next_event(&SnowTime::from_time_ts(from_ts)).unwrap();
    assert_eq!(to_datetime(next_execution.to_time_ts(0)), "2021-11-30 02:55:00");

    let cron = SnowSchedule::parse("1 1 * * *").unwrap();
    let from_ts = to_timestamp("2021-11-29 01:16:40");
    let next_execution = cron.next_event(&SnowTime::from_time_ts(from_ts)).unwrap();
    assert_eq!(to_datetime(next_execution.to_time_ts(0)), "2021-11-30 01:01:00");
  }
  ...
  fn test_next_hour() {
    ...
    let from_ts = to_timestamp("2021-11-29 01:16:40");
    let next_execution = cron.next_event(&SnowTime::from_time_ts(from_ts)).unwrap();
    assert_eq!(to_datetime(next_execution.to_time_ts(0)), "2021-11-29 02:00:00");

    let cron = SnowSchedule::parse("15 * * * *").unwrap();
    let from_ts = to_timestamp("2021-11-29 01:16:40");
    let next_execution = cron.next_event(&SnowTime::from_time_ts(from_ts)).unwrap();
    assert_eq!(to_datetime(next_execution.to_time_ts(0)), "2021-11-29 02:15:00");
  }
  ...
  fn test_next_minutes() {
    ...
    let from_ts = to_timestamp("2021-11-29 01:16:40");
    let next_execution = cron.next_event(&SnowTime::from_time_ts(from_ts)).unwrap();
    assert_eq!(to_datetime(next_execution.to_time_ts(0)), "2021-11-29 01:21:00");

    let cron = SnowSchedule::parse("*/5 * * * *").unwrap();
    let from_ts = to_timestamp("2021-11-29 01:16:40");
    let next_execution = cron.next_event(&SnowTime::from_time_ts(from_ts)).unwrap();
    assert_eq!(to_datetime(next_execution.to_time_ts(0)), "2021-11-29 01:20:00");
  }
  ...
  fn test_next_weekday() {
    ...
    let next_execution = cron.next_event(&SnowTime::from_time_ts(from_ts)).unwrap();
    assert_eq!(to_datetime(next_execution.to_time_ts(0)), "2021-11-30 00:00:00"); 
   
    // Find next Saturday
    let cron = SnowSchedule::parse("* * * * 6").unwrap();
    let from_ts = to_timestamp("2021-11-29 01:16:40"); // Monday
    let next_execution = cron.next_event(&SnowTime::from_time_ts(from_ts)).unwrap();
    assert_eq!(to_datetime(next_execution.to_time_ts(0)), "2021-12-04 00:00:00");
    
    // Find next Monday
    let cron = SnowSchedule::parse("0 1 * * 1").unwrap();
    let from_ts = to_timestamp("2021-11-29 01:16:40"); // Monday
    let next_execution = cron.next_event(&SnowTime::from_time_ts(from_ts)).unwrap();
    assert_eq!(to_datetime(next_execution.to_time_ts(0)), "2021-12-06 01:00:00");

    // Find next Friday, Feb 29th
    let cron = SnowSchedule::parse("0 8 29 2 5").unwrap();
    let from_ts = to_timestamp("2021-11-29 01:16:40"); // Monday
    let next_execution = cron.next_event(&SnowTime::from_time_ts(from_ts)).unwrap();
    assert_eq!(to_datetime(next_execution.to_time_ts(0)), "2036-02-29 08:00:00");
  }
}
